...
private:
	void ChkHitANDBroadcast(UINT8 attackType, UINT32 ID,
		UINT8 direction, UINT16 x, UINT16 y);
	void HeaderANDMsgUnicast(UINT8 msgType, 
		char* msg, int size, Player* pPlayer);
	void HeaderANDMsgBroadcast(UINT8 msgType, 
		char* msg, int size, Player* pExpPlayer = nullptr);
};
