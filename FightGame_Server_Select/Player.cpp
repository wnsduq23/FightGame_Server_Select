...
_moveDirection, _x, _y);
	...
	_headDirection = packetMoveStop.Direction;
	_x = packetMoveStop.X;
	_y = packetMoveStop.Y;
	SetPacketMoveStop();
	SetStateMoveStop();
...
_ID, packetAttack1.Direction, packetAttack1.X, packetAttack1.Y, _x, _y);
	...
	_headDirection = packetAttack1.Direction;
	_x = packetAttack1.X;
	_y = packetAttack1.Y;
	SetPacketAttack1();
}
...
_ID, packetAttack2.Direction, packetAttack2.X, packetAttack2.Y, _x, _y);
	...
	_headDirection = packetAttack2.Direction;
	_x = packetAttack2.X;
	_y = packetAttack2.Y;
	SetPacketAttack2();
}
...
_ID, packetAttack3.Direction, packetAttack3.X, packetAttack3.Y, _x, _y);
	...
	_headDirection = packetAttack3.Direction;
	_x = packetAttack3.X;
	_y = packetAttack3.Y;
	SetPacketAttack3();
}
